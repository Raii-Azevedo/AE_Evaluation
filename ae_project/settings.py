...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # logo após Security, antes de tudo
...
WSGI_APPLICATION = "ae_project.wsgi.application"
...
# WhiteNoise: comprime e cacheia estáticos em produção
STORAGES = {
    "default": {
